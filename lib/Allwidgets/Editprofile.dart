...
//  ===========    *****    Update  Profile   Api    *******      ==========
  ...
  Future<void> getProfessionApi() async {
    ...
    var usertoken = prefs.getString('token');
    if (usertoken != null) {
      final Uri uri = Uri.parse("https://madadguru.webkype.net/api/getProfession");
      try {
        final response = await http.post(
          uri,
          headers: {
                      ...
                      children: [
                                  ...
                                  ? CircleAvatar(
                                      ...
                                      child: ClipOval(
                                        child: Image.network(
                                          ...
                                          width: 90.0, // adjust width as needed
                                          height:
                                              90.0,  errorBuilder: (context, error, stackTrace) {
                                          return Icon(
                                            Icons.person,
                                            size: 50,
                        ...
                        Container(
                          ...
                          child:
                             ...
                             child: Text(
                              _mobilController.text.isNotEmpty ? _mobilController.text : 'Loading...', style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.w400,
                              fontSize: 12,
                            ),
                              ...
                              child: DropdownButton<String>(
                                ...
                                icon: const Icon(
                                  ...
                                  color: Colors.black38,
                                   ...
                                   hint: Text(
                                     _genderController.text.isNotEmpty ? _genderController.text : 'Loading...',
                                       // gender ?? 'Loading',
                            ...
                            decoration: InputDecoration(
                              suffixIcon: IconButton(
                                onPressed: () async {
                                  ...
                                  DateTime firstAllowedDate = DateTime(currentDate.year - 100); // Restrict to 100 years ago
                                  DateTime? pickedDate = await showDatePicker(
                                    context: context,
                          ...
                          child: InputDecorator(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<Map<String, dynamic>>(
                                ...
                                hint: Text(
                                  _professionController.text.isNotEmpty ? _professionController.text : 'Loading...',
                                  // "Profession",
                                  style: GoogleFonts.roboto(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400,
