  ...
  void updateSwitchStates() {
    if (voluteerData.containsKey('i_want')) {
      ...
      setState(() {
        ...
        for (int i = 0; i < Data2.length; i++) {
          switchStates[i] =
              voluteerData['i_want'].contains(Data2[i]['id'].toString());
        }
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                voluteerData["email"] ?? 'xxxxxxxxxxx',
                              ...
                              Text(
                                "Mobile: ${(voluteerData["mobile"] != null) ? voluteerData["mobile"] : 'xxxxxxxxxx'}",
                                style: GoogleFonts.roboto(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                  color: Colors.black,
                              ...
                              Text(
                                "Dob: ${(voluteerData["dob"] != null) ? voluteerData["dob"] : 'xxxxxxxxxx'}",
                                style: GoogleFonts.roboto(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                  color: Colors.black,
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      "Gender: ${(voluteerData["gender"] != null) ? voluteerData["gender"] : 'xxxxxxxxx'}",
                                      style: GoogleFonts.roboto(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w400,
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      "Language: ${(voluteerData["language"] != null) ? voluteerData["language"] : 'xxxxxxxxx'}",
                                      style: GoogleFonts.roboto(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w400,
...
//
// class hideDataScreen extends StatefulWidget {
//   // final String device;
//   // final int postId;
//   const hideDataScreen({
//     super.key,
//     // required this.device,
//     // required this.postId,
//   });
//   @override
//   State<hideDataScreen> createState() => _hideDataScreenState();
// }
// class _hideDataScreenState extends State<hideDataScreen> {
//   int segmentedControlValue = 0;
//   bool isActive = false;
//   Map JobDetail = {};
//
...
//
//   bool isLoading = false;
//   Map<String, dynamic> userVoluteerData = {};
//
//   get switchesEnabled => false;
//
//   @override
...
//             var userData = responseData['data'];
//             setState(() {
//               userVoluteerData = userData;
//               fetchDatagetWant(userVoluteerData["i_want"]);
//             });
//           } else {
//             print('API request failed: ${responseData["message"]}');
//           }
...
//
//   void updateIWant() {
//     if (userVoluteerData.containsKey('i_want')) {
//       setState(() {
//         iwant = userVoluteerData['i_want'];
//       });
//       print("i want's value: $iwant");
//     }
//   }
...
//         for (int i = 0; i < Data2.length; i++) {
//           switchStates[i] =
//               userVoluteerData['i_want'].contains(Data2[i]['id'].toString());
//         }
//         print('Updated switchStates: $switchStates');
//       });
//     } else {
...
//     if (userVoluteerData.containsKey('i_need_help')) {
//       // setState(() {
...
//                       Text(
//
//                         // (userVoluteerData["name"] != null)
//                         //     ? userVoluteerData["name"]
//                         //     : 'Name not available',
//                         "xxxxxxxxxxx",
//                         style: GoogleFonts.roboto(
//                           fontSize: 14,
...
//                       Text(
//                         "xxxxxxxxxxx",
//                         // (userVoluteerData["profession"] != null) ? userVoluteerData["profession"] : 'profession not available',
//
//                         style: GoogleFonts.roboto(
//                           fontSize: 12,
//                           fontWeight: FontWeight.w400,
...
//                       Text(
//                         'xxxxxxxxxxx',
//                         // "Mobile: ${(userVoluteerData["mobile"] != null) ? userVoluteerData["mobile"] : 'mobile not available'}",
//                         style: GoogleFonts.roboto(
//                           fontSize: 12,
//                           fontWeight: FontWeight.w400,
//                           color: Colors.black,
...
//                       Text(
//                         'xxxxxxxxxxx',
//                         // "Dob: ${(userVoluteerData["dob"] != null) ? userVoluteerData["dob"] : "dob not available"}",
//                         style: GoogleFonts.roboto(
//                           fontSize: 12,
//                           fontWeight: FontWeight.w400,
//                           color: Colors.black,
...
//                       Text(
//                         'xxxxxxxxxxx',
//                         // (userVoluteerData["profession"] != null)
//                         //     ? userVoluteerData["profession"]
...
//                             child: Text(
//                               'xxxxxxxxxxx',
//                               // "Gender: ${(userVoluteerData["gender"] != null) ? userVoluteerData["gender"] : "dob not available"}",
//                               style: GoogleFonts.roboto(
//                                 fontSize: 12,
//                                 fontWeight: FontWeight.w400,
//                                 color: Color(0xff3600FF),
...
//                             child: Text(
//                               'xxxxxxxxxxx',
//                               // "Language: ${(userVoluteerData["language"] != null) ? userVoluteerData["language"] : "language not available"}",
//                               style: GoogleFonts.roboto(
//                                 fontSize: 12,
//                                 fontWeight: FontWeight.w400,
//                                 color: Color(0xff096001),
...
//                         child: ClipOval(
//                           child: Image.network(
//                             userVoluteerData['profile'] ?? 'No Image',
//                             fit: BoxFit.cover,
...
//                       // (userVoluteerData["about"] != null)
//                       //     ? userVoluteerData["about"]
//                       //     : 'about not available',
//
//                       style: GoogleFonts.roboto(
//                         fontSize: 12,
