  ...
  void updateSwitchStates() {
    ...
    if (userVoluteerData.containsKey('i_want')) {
      ...
      setState(() {
        switchStates = List<bool>.filled(Data2.length, false);
        for (int i = 0; i < Data2.length; i++) {
          switchStates[i] = userVoluteerData['i_want'].contains(Data2[i]['id'].toString());
        }
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                (userVoluteerData["email"] != null)
                                    ? userVoluteerData["email"]
                                    : 'email not available',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      "Language: ${(userVoluteerData["language"] != null) ? userVoluteerData["language"] : "dob not available"}",
                          ...
                          child: CircleAvatar(
                            ...
                            child: Center(
                              child: CircleAvatar(
                                radius: 45,
                                child: ClipOval(
                                  child: userVoluteerData.containsKey('profile')
                                      ? Image.network(
                                          userVoluteerData['profile'],
                                          fit: BoxFit.cover,
